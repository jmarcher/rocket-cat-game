...
public class Bob extends DynamicGameObject {
    ...
    public static final float BOB_HEIGHT = 1.2f;
    ...
    public void update(float deltaTime) {
        ...
        fireParticle.setPosition(this.position.x, this.position.y);
        fireParticle.update(deltaTime);
