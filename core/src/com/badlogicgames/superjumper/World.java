...
public class World {
    ...
    public static final Vector2 gravity = new Vector2(20, -20);
    ...
    private void generateLevel() {
        ...
        while (y < WORLD_HEIGHT - WORLD_WIDTH / 2) {
            ...
            if (y > WORLD_HEIGHT / 3 && randomizer.nextFloat() > 0.8f) {
                Squirrel squirrel = new Squirrel(platform.position.x + randomizer.nextFloat(), platform.position.y
                        + Squirrel.SQUIRREL_HEIGHT + randomizer.nextFloat() * 2);
                squirrels.add(squirrel);
            }

            if (randomizer.nextFloat() > 0.6f) {
                Coin coin = new Coin(platform.position.x + randomizer.nextFloat(), platform.position.y + Coin.COIN_HEIGHT
